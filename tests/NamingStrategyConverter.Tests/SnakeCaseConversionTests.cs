...
public class SnakeCaseConversionTests
{
    ...
    [InlineData("SomeMixedCASEString", "some_mixed_case_string", NamingStrategy.Unknown)]
    [InlineData("Special@#%&*()Characters", "special@#%&*()characters", NamingStrategy.Unknown)]
    [InlineData("StringWith123Numbers", "string_with123numbers", NamingStrategy.Unknown)]
